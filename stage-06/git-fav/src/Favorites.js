...
export class Favorites {
  ...
  remove(userRemoved) {
    const isOk = confirm(`Tem certeza que deseja remover ${userRemoved.name}?`)
  ...
  update() {
    ...
    this.users.forEach(user => {
      ...
      img.alt = `Imagem de perfil de ${user.name}`
  ...
  createRow() {
    ...
    tr.innerHTML = `
    <td class="user">
      <a href="https://github.com/isadoraguiar" target="_blank" rel="external">
        <img
          src="https://github.com/isadoraguiar.png"
          alt="Imagem de perfil de Isadora Aguiar"
        />
        <div>
          <p>Isadora Aguiar</p>
